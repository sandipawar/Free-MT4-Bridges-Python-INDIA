...
extern    string   priceType    =   "MKT" ;

extern    string   exchange   =  "NFO"  ;

extern    string   expiry   =  "28MAR24"  ;
   ...
   if(exchange == "NFO")
     {
      ...
      if(signal_mapping =="B")
        ...
        if(ArraySize(output1)   ==     2)
          {
          return SYMBOL_NAME_ONE + expiry + "C"  +  closestMultiple(Ask, 100);
           
          }else
             {
              return SYMBOL_NAME_ONE + expiry + "C"  +  closestMultiple(Ask, 50);
             }
        }
      ...
      if(signal_mapping =="S")
        ...
        if(ArraySize(output1)   ==     2)
          {
          return SYMBOL_NAME_ONE + expiry + "P"  +  closestMultiple(Ask, 100);
           
          }else
             {
              return SYMBOL_NAME_ONE + expiry + "P"  +  closestMultiple(Ask, 50);
             }
